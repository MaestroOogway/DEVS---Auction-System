...
{
}; // Cambia según la salida esperada de Rational.
...
int main()
{
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader, round_result_reader, final_result_reader, rational_model};

    dynamic::modeling::EICs eics_TOP = {}; // No hay puertos de entrada en este ejemplo
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC<Rational_defs::out_bidOffer, top_out>("rational_model")};
    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<Message_initialIP_t>::out, Rational_defs::in_initialIP>(
            "input_reader", "rational_model"),
        dynamic::translate::make_IC<iestream_input_defs<Message_roundResult_t>::out, Rational_defs::in_roundResult>(
            "round_result_reader", "rational_model"),
        dynamic::translate::make_IC<iestream_input_defs<Message_finalResults_t>::out, Rational_defs::in_finalResult>(
            "final_result_reader", "rational_model")};
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/rational_test_output_messages.txt");
    ...
    static ofstream out_state("../simulation_results/rational_test_output_state.txt");
